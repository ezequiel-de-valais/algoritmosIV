       ...
       DETERMINAR-CLAVE-MENOR-PAT.
           MOVE ALQ-PATENTE TO CLVMENOR-PATENTE

           IF SOL1-PATENTE  < CLVMENOR-PATENTE
               MOVE SOL1-PATENTE TO CLVMENOR-PATENTE
           END-IF.

           IF SOL2-PATENTE  < CLVMENOR-PATENTE
               MOVE SOL2-PATENTE TO CLVMENOR-PATENTE
           END-IF.

           IF SOL3-PATENTE  < CLVMENOR-PATENTE
               MOVE SOL3-PATENTE TO CLVMENOR-PATENTE
           END-IF.
       ...
       IMPRIMIR-LIST-DESCAUTO.
           ...
           IF CANT-LINEAS IS GREATER THAN 60
               ...
               ADD 9 TO CANT-LINEAS
           END-IF.
           MOVE VECAUT-PATENTE(INDICE)(1:3)
  f         TO LIST-DESCAUTO-PATENTE-LETRAS.
           MOVE VECAUT-PATENTE(INDICE)(4:3)
           TO LIST-DESCAUTO-PATENTE-NUMEROS.
