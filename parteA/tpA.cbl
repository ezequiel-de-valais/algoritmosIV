       ...
       01 LISTADO-DESCAUTO-LINEA-2.
           ...
           03 FILLER PIC X(16) VALUE   SPACES.
           03 FILLER PIC X(10) VALUE   SPACES.
       01 LISTADO-DESCAUTO-LINEA-3.
           03 FILLER PIC X(16) VALUE   SPACES.
           03 FILLER PIC X(18) VALUE
           "           Color: ".
           03 E3-COLOR     PIC X(10).
           03 FILLER PIC X(36) VALUE   SPACES.
       01 LISTADO-DESCAUTO-LINEA-4.
           03 FILLER PIC X(16) VALUE   SPACES.
       ...
       AUTO-ENCONTRADO.
           ...
           IF TOTGRAL IS NOT EQUAL TO ZERO
               ...
               PERFORM IMPRIMIR-LISTADO-LINEA--1-Y-2
           END-IF.
           PERFORM IMPRIMIR-LISTADO-LINEA--PATENTE.



       IMPRIMIR-LISTADO-LINEA--PATENTE.
           ...
           MOVE VECAUT-TAMANO(INDICE) TO E3-TAMANO.
           DISPLAY LISTADO-DESCAUTO-LINEA-1.
           DISPLAY LISTADO-DESCAUTO-LINEA-2.
           DISPLAY LISTADO-DESCAUTO-LINEA-3.
           DISPLAY LISTADO-DESCAUTO-LINEA-4.
           DISPLAY LISTADO-COLUMNAS.
           DISPLAY LISTADO-SEPARADOR.
           MOVE LISTADO-DESCAUTO-LINEA-1(1:80) TO REG-LIST-APROBADOS.
           WRITE REG-LIST-APROBADOS.
           MOVE LISTADO-DESCAUTO-LINEA-2(1:80) TO REG-LIST-APROBADOS.
           WRITE REG-LIST-APROBADOS.
           MOVE LISTADO-DESCAUTO-LINEA-3(1:80) TO REG-LIST-APROBADOS.
           WRITE REG-LIST-APROBADOS.
           MOVE LISTADO-DESCAUTO-LINEA-4(1:80) TO REG-LIST-APROBADOS.
           WRITE REG-LIST-APROBADOS.
           MOVE LINEA-VACIA TO REG-LIST-APROBADOS.
           WRITE REG-LIST-APROBADOS.
       ...
       IMPRIMIR-TOTALES-POR-PATENTE.
           ...
           DISPLAY LISTADO-TOTALES-LINEA-7.
           DISPLAY LINEA-VACIA.
           DISPLAY LINEA-VACIA.
           MOVE LISTADO-TOTALES-LINEA-7 TO REG-LIST-APROBADOS.
           WRITE REG-LIST-APROBADOS.
           MOVE LINEA-VACIA TO REG-LIST-APROBADOS.
           WRITE REG-LIST-APROBADOS.
           MOVE LINEA-VACIA TO REG-LIST-APROBADOS.
       ...
       IMPRIMIR-TOT-GRAL.
         ...
         IF CANT-LINEAS IS GREATER THAN 60
           ...
           DISPLAY LISTADO-TOTALES-LINEA-8.
           MOVE LISTADO-TOTALES-LINEA-8 TO REG-LIST-APROBADOS.
           WRITE REG-LIST-APROBADOS.
